...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-02-28 00:11 EST
...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-03-01 06:11 EST
Nmap scan report for 10.10.10.40
Host is up (0.19s latency).
Not shown: 992 closed ports
PORT      STATE SERVICE
...
https:/ map.org/book/man-nse.html

## その他の方法
基本的にその他の writeup も最終的にはこの exploit を使っていましたが、それにたどり着くまでの道のりが少し違っていたりしました。

https:/ eptunexps.blogspot.com/2019/11/blue-hackthebox.html
- MS17-010 使ってるけど結構違う
- `--script="smb-vuln*"`で script を絞って実行してる
- `ls /usr/share map/scripts/ | grep "smb-vuln"`で確認できる
