...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-05-04 15:18 EDT
...
for the remaining tests, do you want to include all tests for 'MySQL' extending provided level (1) and risk (1) values? [Y ] y
...
do you want to store hashes to a temporary file for eventual further processing with other tools [y ] y
[03:31:25] [INFO] writing hashes to a temporary file '/tmp/sqlmap2wauza2i3895/sqlmaphashes-8ui0fa_5.txt' 
do you want to crack them via a dictionary-based attack? [Y /q] y
...
do you want to use common password suffixes? (slow!) [y ] y
