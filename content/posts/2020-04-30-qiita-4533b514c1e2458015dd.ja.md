...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-04-29 15:57 UTC
...
## nmap（smbのスキャン）
ファイル共有の一覧を列挙
https:/ map.org sedoc/scripts/smb-enum-shares.html

リモートの Windows システム上のユーザーを列挙
https:/ map.org sedoc/scripts/smb-enum-users.html
...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-04-29 16:11 UTC
Nmap scan report for ip-10-10-162-244.eu-west-1.compute.internal (10.10.162.244)
...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-04-29 16:17 UTC
...
## nmap
https:/ map.org sedoc/scripts fs-ls.html
https:/ map.org sedoc/scripts fs-showmount.html
https:/ map.org sedoc/scripts fs-statfs.html

```
root@kali:~# nmap -p 111 -script=nfs-ls,nfs-statfs,nfs-showmount 10.10.162.244
Starting Nmap 7.80 ( https:/ map.org ) at 2020-04-29 17:18 UTC
Nmap scan report for ip-10-10-162-244.eu-west-1.compute.internal (10.10.162.244)
...
```
kenobi@kenobi:~$ find / -perm -u=s -type f 2>/dev ull
/sbin/mount.nfs
